...
class Program
{
   static void Main(string[] args)
   {
      ...
      video1.AddComment(new Video.Comment("For new job", "Laura Anderson"));
      ...
      video2.AddComment(new Video.Comment("Philippian 4: 13 'I can do all things through Christ which strengtheneth me'", "Camila Garcia"));
      video2.AddComment(new Video.Comment("Proverbs 1:7  'The fear of the Lord is the beginning of knowledge'", "Aurora Wilson"));
      video2.AddComment(new Video.Comment("Matthew 11: 28 'I can do all things through Christ which strengtheneth me'", "Liam Jackson "));
      videos.Add(video2);
